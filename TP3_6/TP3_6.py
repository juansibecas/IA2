...
def iniciar(numero_clases, numero_ejemplos, graficar_datos):
    ...
    if graficar_datos:
        ...
        plt.show()
    precision_op=0
    NEURONAS_CAPA_OCULTA_op=0
    LEARNING_RATE_op=0
    for i in range(50):
        # Inicializa pesos de la red
        NEURONAS_CAPA_OCULTA = random.randint(50,200)
        NEURONAS_ENTRADA = 2
        ...
        print("-------",i,"------- ")
        print("NCO : ",NEURONAS_CAPA_OCULTA)
        print("LR : ",LEARNING_RATE) 
        precision_op_aux = train(x, t, pesos, LEARNING_RATE, EPOCHS, CROSS_VALIDATION_TOLERANCE, x_val, t_val)       
        if precision_op_aux > precision_op:
            precision_op=precision_op_aux
            NEURONAS_CAPA_OCULTA_op=NEURONAS_CAPA_OCULTA
            LEARNING_RATE_op=LEARNING_RATE       
            pesos_op=pesos
    
    #NEW Precisión de clasificación
    aciertos = 0       
    resultados = clasificar(x_test, pesos_op)
    ...
    print("NCO-OP: ",NEURONAS_CAPA_OCULTA_op)
    print("LR-OP: ",LEARNING_RATE_op)  
