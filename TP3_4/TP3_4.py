...
from Examples import generar_mas_datos_clasificacion
...
def iniciar(numero_clases, numero_ejemplos, graficar_datos):
    # Generamos datos
    x, t = generar_mas_datos_clasificacion(numero_ejemplos, numero_clases)
    
    # NEW Generamos ejemplos para test
    x_test, t_test = generar_mas_datos_clasificacion(int(numero_ejemplos/5), numero_clases)
    
    # NEW Generamos ejemplos para validacion
    x_val, t_val = generar_mas_datos_clasificacion(int(numero_ejemplos/5), numero_clases)
...
iniciar(numero_clases=5, numero_ejemplos=2700, graficar_datos=True)