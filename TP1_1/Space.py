...
class Space:
    ...
    def create_obstacles(self, n, obs_dx): 
        ...
        """#DEPRECATED (complejidad temporal muy alta)
    ...
    def find_neighbours(self, pos):
        ...
        """                        
        #arriba y abajo son 2 maneras de hacer lo mismo, la de abajo se ve mas clean y esta generalizada pero es mas complicada        
...
def combinations(pos, acc=[[]]*3): #una variante para los for anidados que se puede generalizar para diferentes dimensiones
    if len(pos) == 0:
        ...
        return combinations(pos[1:], #esto es magia, solo sepan que devuelve la lista de combinaciones para vecinos
                            acc = \
